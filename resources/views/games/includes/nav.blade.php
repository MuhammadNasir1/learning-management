    ...
    <div class="grid grid-cols-3 items-center px-6 py-5">
        <div>
            <div class="flex items-center gap-5 ">
                ...
                <h2 class="text-4xl font-semibold  leading-none">@lang('lang.Games')</h2>
                ...
                <div data-popover id="popover-bottom" role="tooltip"
                    ...
                    <div class="px-3 py-2 bg-gray-100 ">
                        <h3 class="font-semibold text-gray-900 ">Random Card</h3>
                    </div>
                    <div class="px-3 py-2">
                        <p>Here app will display Word randomly and below the word user can get 3 audio that user can
                            play and navigate to next and previous word. Once all words are completed in random
                            order then the game will be completed or random again.</p>
                    </div>
